...
public class TDSwordMenu extends AbstractContainerMenu {
    ...
    public TDSwordMenu(int id, Inventory inv, ItemStack itemStack, ItemStackHandler slots) {
        ...
        if(!this.isActivated) this.TE_INVENTORY_SLOT_COUNT = 1;
        else this.TE_INVENTORY_SLOT_COUNT = 3;
        //this.data = data;
        addPlayerHotbar(inv);
    ...
    private static int TE_INVENTORY_SLOT_COUNT = 0;  // must be the number of slots you have!
